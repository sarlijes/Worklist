...
|9.5.2021   | 6  | Added logic to avoid duplicate material names. Refectored code: removed commented code, made lines match the 120 char limit, fixed some typos. Removed duplicate files. Extend documentation. Bug fixes. |
|14.5.2021   | 2  | Extend documentation |
|14.5.2021   | 1  | Testing |
|   |   |   |
|total   | 75   |   |